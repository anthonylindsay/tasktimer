...
var log_html = {"html":"<div id='log-container'></div> ", "button":"<form id='log-button-form' class='button-form'><button id='log-button' value='log' type='button' title='View log.'>View log</button></form>"}
